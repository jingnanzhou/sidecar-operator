...
import (
	...
	scheme "github.com/jingnanzhou/sidecar-operator/pkg/generated/clientset/versioned/scheme"
...
type SidecarInterface interface {
	Create(*v1alpha1.Sidecar) (*v1alpha1.Sidecar, error)
	Update(*v1alpha1.Sidecar) (*v1alpha1.Sidecar, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1alpha1.Sidecar, error)
	List(opts v1.ListOptions) (*v1alpha1.SidecarList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.Sidecar, err error)
	SidecarExpansion
}
...
func newSidecars(c *IncubationV1alpha1Client, namespace string) *sidecars {
	return &sidecars{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *sidecars) Get(name string, options v1.GetOptions) (result *v1alpha1.Sidecar, err error) {
	result = &v1alpha1.Sidecar{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("sidecars").
		Name(name).
...
func (c *sidecars) List(opts v1.ListOptions) (result *v1alpha1.SidecarList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.SidecarList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("sidecars").
...
func (c *sidecars) Create(sidecar *v1alpha1.Sidecar) (result *v1alpha1.Sidecar, err error) {
	result = &v1alpha1.Sidecar{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("sidecars").
...
func (c *sidecars) Update(sidecar *v1alpha1.Sidecar) (result *v1alpha1.Sidecar, err error) {
	result = &v1alpha1.Sidecar{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("sidecars").
...
func (c *sidecars) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.Sidecar, err error) {
	result = &v1alpha1.Sidecar{}
