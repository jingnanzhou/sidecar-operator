...
type SidecarLister interface {
	...
	List(selector labels.Selector) (ret []*v1alpha1.Sidecar, err error)
...
// List lists all Sidecars in the indexer.
func (s *sidecarLister) List(selector labels.Selector) (ret []*v1alpha1.Sidecar, err error) {
	err = cache.ListAll(s.indexer, selector, func(m interface{}) {
		ret = append(ret, m.(*v1alpha1.Sidecar))
	})
	return ret, err
}
...
type SidecarNamespaceLister interface {
	...
	Get(name string) (*v1alpha1.Sidecar, error)
...
// List lists all Sidecars in the indexer for a given namespace.
func (s sidecarNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.Sidecar, err error) {
...
// Get retrieves the Sidecar from the indexer for a given namespace and name.
func (s sidecarNamespaceLister) Get(name string) (*v1alpha1.Sidecar, error) {
	obj, exists, err := s.indexer.GetByKey(s.namespace + "/" + name)
	if err != nil {
		return nil, err
	}
	if !exists {
		return nil, errors.NewNotFound(v1alpha1.Resource("sidecar"), name)
	}
	return obj.(*v1alpha1.Sidecar), nil
}
