...
import (
	...
	incubationv1alpha1 "github.com/jingnanzhou/sidecar-operator/pkg/apis/incubation/v1alpha1"
	versioned "github.com/jingnanzhou/sidecar-operator/pkg/generated/clientset/versioned"
	internalinterfaces "github.com/jingnanzhou/sidecar-operator/pkg/generated/informers/externalversions/internalinterfaces"
	v1alpha1 "github.com/jingnanzhou/sidecar-operator/pkg/generated/listers/incubation/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.IncubationV1alpha1().Sidecars(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.IncubationV1alpha1().Sidecars(namespace).Watch(options)
			},
		},
		&incubationv1alpha1.Sidecar{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *sidecarInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&incubationv1alpha1.Sidecar{}, f.defaultInformer)
}

func (f *sidecarInformer) Lister() v1alpha1.SidecarLister {
	return v1alpha1.NewSidecarLister(f.Informer().GetIndexer())
}
